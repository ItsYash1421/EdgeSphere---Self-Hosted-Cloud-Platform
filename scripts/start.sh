...
print_urls() {
  ...
  echo -e "${BLUE}╠══════════════════════════════════════════════╣${NC}"
  echo -e "${BLUE}║${NC}  🖥️  Dashboard      → ${GREEN}http://localhost:3000${NC}  (Frontend)"
  echo -e "${BLUE}║${NC}  🚦  API Gateway    → ${GREEN}http://localhost:8080${NC}  (Backend entry)"
  echo -e "${BLUE}║${NC}  🔐  Auth Service   → ${GREEN}http://localhost:8081${NC}"
  echo -e "${BLUE}║${NC}  🗄️  Storage        → ${GREEN}http://localhost:8082${NC}"
  echo -e "${BLUE}║${NC}  📈  Analytics      → ${GREEN}http://localhost:8083${NC}"
  echo -e "${BLUE}║${NC}  💊  Cache Service  → ${GREEN}http://localhost:8084${NC}"
  echo -e "${BLUE}║${NC}  🔔  Notifications  → ${GREEN}http://localhost:8085${NC}"
  echo -e "${BLUE}║${NC}  🔌  WebSocket      → ${GREEN}ws://localhost:8086${NC}"
  echo -e "${BLUE}║${NC}  🌐  CDN Edge A     → ${GREEN}http://localhost:8087${NC}"
  echo -e "${BLUE}║${NC}  🌐  CDN Edge B     → ${GREEN}http://localhost:8088${NC}"
  echo -e "${BLUE}╠══════════════════════════════════════════════╣${NC}"
